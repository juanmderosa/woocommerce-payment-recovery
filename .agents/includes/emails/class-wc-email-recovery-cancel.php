...
class WC_Email_Payment_Recovery_Cancel extends WC_Email_Payment_Recovery_Base
{
    ...
    public function __construct()
    {
        ...
        $this->heading = 'El pedido #{order_number} ha sido cancelado';
        $this->subject = 'Tu pedido fue cancelado';
    ...
    protected function get_message()
    {
        ...
        return "Como no se completó el pago dentro del plazo de reserva, tu pedido fue cancelado y el stock volvió a estar disponible. Si todavía querés esas prendas, podés volver a comprarlas en nuestra tienda online ";
    }
